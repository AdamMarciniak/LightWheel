    ...
    if (ledChrono.hasPassed((long)(1500000 / 360))) {
      ...
      if (ledReady == true) {
        ...
        memcpy(&armBuffer[BYTES_PER_ARM],
               &flashReadBuffer[(armPos * BYTES_PER_ARM + ARM_BETWEEN_SIZE) %
                                BYTES_PER_FRAME],
               BYTES_PER_ARM);
        memcpy(&armBuffer[BYTES_PER_ARM * 2],
               &flashReadBuffer[(armPos * BYTES_PER_ARM + ARM_2_BETWEEN) %
                                BYTES_PER_FRAME],
               BYTES_PER_ARM);
        memcpy(&armBuffer[BYTES_PER_ARM * 3],
               &flashReadBuffer[(armPos * BYTES_PER_ARM + ARM_3_BETWEEN) %
                                BYTES_PER_FRAME],
               BYTES_PER_ARM);
